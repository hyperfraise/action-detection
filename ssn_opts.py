...
parser.add_argument(
    ...
    type=float,
    metavar="DO",
    help="dropout ratio (default: 0.8)",
)

# ========================= Learning Configs ==========================
parser.add_argument(
    "--epochs", default=7, type=int, metavar="N", help="number of total epochs to run"
)
parser.add_argument(
...
parser.add_argument(
    "--bn_mode", "--bn", default="frozen", type=str, help="the mode of bn layers"
)
parser.add_argument(
    "--comp_loss_weight",
    "--lw",
    ...
    type=float,
    metavar="LW",
    help="the weight for the completeness loss",
)
parser.add_argument(
    "--reg_loss_weight",
    "--rw",
    ...
    type=float,
    metavar="LW",
    help="the weight for the location regression loss",
)
