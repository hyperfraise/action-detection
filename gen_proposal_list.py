...
process_proposal_list(
    norm_list_tmpl.format(configs["train_list"]),
    out_list_tmpl.format(configs["train_list"]),
    frame_dict,
)
process_proposal_list(
    norm_list_tmpl.format(configs["test_list"]),
    out_list_tmpl.format(configs["test_list"]),
    frame_dict,
)
